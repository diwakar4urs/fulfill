...
class FW_Option_Type_NewIcon extends FW_Option_Type {
    ...
    private function generate_unknown_set($icon) {
        return array(
            ...
            'container-class' => '',
            'groups' => array(
                'unknown' => esc_html__('Unknown Set', 'soccer-acumen'),
            ),
            'icons' => array(
    ...
    private function get_default_sets() {
		...
		//     groups => array(
        //         array(
        //             'title' => esc_html__('Web Application Icons', 'soccer-acumen')
        //             'icons' => array('fa fa-adjust', 'fa fa-anchor', ...),
        //         ),
        //         array(
        //             'title' => esc_html__('Transportation Icons', 'soccer-acumen'),
        //             'icons' => array(...),
        //         ),
        //     )
        //
        ...
        return array(
            'font-awesome' => array(// http://fortawesome.github.io/Font-Awesome/icons
                ...
                'groups' => array(
                    'web-application' => esc_html__('Web Application Icons', 'soccer-acumen'),
                    'hand' => esc_html__('Hand Icons', 'soccer-acumen'),
                    'transportation' => esc_html__('Transportation Icons', 'soccer-acumen'),
                    'gender' => esc_html__('Gender Icons', 'soccer-acumen'),
                    'file-type' => esc_html__('File Type Icons', 'soccer-acumen'),
                    //'spinner'         => 'Spinner Icons',
                    //'form-control'    => 'Form Control Icons',
                    'payment' => esc_html__('Payment Icons', 'soccer-acumen'),
                    //'chart'           => 'Chart Icons',
                    'currency' => esc_html__('Currency Icons', 'soccer-acumen'),
                    'text-editor' => esc_html__('Text Editor Icons', 'soccer-acumen'),
                    'directional' => esc_html__('Directional Icons', 'soccer-acumen'),
                    'video-player' => esc_html__('Video Player Icons', 'soccer-acumen'),
                    'brand' => esc_html__('Brand Icons', 'soccer-acumen'),
                    'medical' => esc_html__('Medical Icons', 'soccer-acumen'),
                    'soccer-acumen' => esc_html__('Soccer Icons', 'soccer-acumen'),
                ),
                'icons' => array(
                    ...
                    'icon-Icon1' => array('group' => 'soccer-acumen'),
                    'icon-Icon2' => array('group' => 'soccer-acumen'),
                    'icon-Icon3' => array('group' => 'soccer-acumen'),
                    'icon-Icon4' => array('group' => 'soccer-acumen'),
                ),
            ),
        );
    }
