...
$latitude = !empty($atts['latitude']) ? $atts['latitude'] : '54.932728';
$longitude = !empty($atts['longitude']) ? $atts['longitude'] : '-2.933358';
...
?>
<div class="sc-map">
    <div id="tg-mapcontent-<?php echo esc_attr($uni_flag); ?>" style="height:<?php echo esc_attr($map_height); ?>px" class="tg-mapcontent tg-haslayout"></div>
</div>
<script type='text/javascript'>
    function initialize() {
        ...
        var map = new google.maps.Map(document.getElementById('tg-mapcontent-<?php echo esc_attr($uni_flag); ?>'), mapOptions);
