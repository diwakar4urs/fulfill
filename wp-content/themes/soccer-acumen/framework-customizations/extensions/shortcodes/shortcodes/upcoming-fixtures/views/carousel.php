...
<div class="sc-upcoming-fixtures">
   <?php        
    ...
    $flag	= rand(1,9999);
    ?>
    <div id="fixture-slider-<?php echo esc_attr( $flag );?>" class="tg-otherfixtures-slider tg-tickets">
                    ...
                    <div class="tg-ticket">
                        ...
                        <div class="tg-matchdetail">
                            ...
                            <ul class="tg-matchmetadata">
                                <li><time datetime="<?php echo date_i18n('Y-m-d', strtotime($date_match)); ?>"><?php echo date_i18n(get_option('time_format'), strtotime($date_match)); ?></time></li>
                                <?php if( !empty( $location ) ){?>
   ...
   <?php 
        $slider_scripts	= "jQuery(document).ready(function(e) {
                                var mainswiper = new Swiper('#fixture-slider-".esc_js( $flag )."', {
                                    direction: 'vertical',
                                    slidesPerView: 5,
                                    spaceBetween: 10,
									speed:2000,
